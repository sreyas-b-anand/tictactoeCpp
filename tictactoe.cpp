...
int main()
{
    ...
    cout << CYAN << "\n\nTo input the character in position a22,\n\t" << "Enter 2 2\n"
         << RESET;
    cout << "\n\nSimilarly,input the required positions throughout game \n\n ";
    ...
    while (!winner)
    {
        ...
        do
        {
            ...
            i--;
            j--;
            if (i >= 0 && i < 3 && j >= 0 && j < 3 && ar[i][j] != player1 && ar[i][j] != player2)
            {
                ar[i][j] = player1;
                m++;
                break;
